...
( function () {
    $('.subscribe-btn').on(
        'click', function (e) {
            ...
            document.forms['subscribe-form']['subscribe'].placeholder = 'PON TU CORREO ELECTRÓNICO';
...
$(document).ready(function () {
    ...
    $('.notify-me').submit(function (e) {
        var form = $(this),
            ...
            messageSuccess = 'Tu email se envió',
            messageInvalid = 'Por favor usa un mail válido',
            messageSigned = 'Este correo ya fué enviado',
            messageErrore = 'Error';
        ...
        if (value.length <= 0 || !validateEmail(value)) {
            ...
            self.parentNode.querySelector('.submail').placeholder = 'PON UN CORREO CORRECTO';
            return;
        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                switch (data) {
                    case 0:
                        self['subscribe'].placeholder = 'PON TU CORREO ELECTRÓNICO';
